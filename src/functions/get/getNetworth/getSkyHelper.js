...
const fetchProfileData = async (uuid, profileRes) => {
...
const getSkyHelper = async (profile, uuid, profileRes) => {
   const { memberData, bankBalance } = await fetchProfileData(uuid, profileRes);
