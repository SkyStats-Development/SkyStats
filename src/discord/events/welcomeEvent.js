/*
const { AttachmentBuilder, Client, Events, GatewayIntentBits, EmbedBuilder, WelcomeChannel} = require('discord.js');
...
setInterval(checkForMemberJoins, 100);



async function checkForMemberJoins() {
    client.on('guildMemberAdd', member => {
            ...
            const background = await readFile('src/discord/commands/welcome.jpg');
