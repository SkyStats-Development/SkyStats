...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            const networthraw = await axios.get(`http://103.54.59.82:3000/v2/profile/${uuid2}/${proflieid}?key=${config.api.skyStatsKey}`);
            ...
            const { 
                ...
                const { inventory, inv1, inv2, inv3, inv4, inv5, equipment, eq1, eq2, eq3, eq4, armor, ar1, ar2, ar3, ar4, accessories, acc1, acc2, acc3, acc4, acc5, enderchest, ec1, ec2, ec3, ec4, ec5, pv, pv1, pv2, pv3, pv4, storage, storage1, storage2, storage3, storage4, storage5, wardrobe, wd1, wd2, wd3, wd4, wd5 } = itemsData || {};
            ...
            const embedplayer = {
                ...
                fields: [
                    ...
                    {
                        name: `<:Spawn_Null:1061455273224577024> Pets  (${addNotation("oneLetters", petData) ?? 0
                            })`,
                        value: `${petData}`,
                        inline: false,
                    },
