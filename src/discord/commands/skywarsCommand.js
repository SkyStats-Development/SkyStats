...
module.exports = {
    ...
    execute: async (interaction, client, InteractionCreate) => {
        ...
        //       this.send(`/r [SW] [${player.stats.skywars.level}✫] ${player.nickname}ᐧᐧᐧᐧKDR:${player.stats.skywars.KDRatio}ᐧᐧᐧᐧWLR:${player.stats.skywars.WLRatio}ᐧᐧᐧᐧWS:${player.stats.skywars.winstreak}`
        const embed = {
            color: 0xffa600,
