...
class woolwarsCommand extends MinecraftCommand {
  ...
  async onCommand(username, message) {
    try {
      ...
      this.send(`/r [${toFixed(level, 0)}✫] ${username} » W: ${woolWars.wool_wars.stats.wins} | WLR: ${toFixed(woolWars.wool_wars.stats.wins/woolWars.wool_wars.stats.games_played, 2)} | KDR: ${toFixed(woolWars.wool_wars.stats.kills/woolWars.wool_wars.stats.deaths, 2)} | BB: ${woolWars.wool_wars.stats.blocks_broken} | WP: ${woolWars.wool_wars.stats.wool_placed}`)
    } catch (error) {
