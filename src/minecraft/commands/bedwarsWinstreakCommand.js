...
class DenickerCommand extends MinecraftCommand {
    ...
    async onCommand(username, message) {
        try {
            // Bedwars winstreaks are not available in the API, so we use an external API.
