...
class skyblockCommand extends MinecraftCommand {
  ...
  async onCommand(username, message) {
    try {
      ...
      if (data.status == 404) return this.send('/r There is no player with the given UUID or name or the player has no Skyblock profiles')
